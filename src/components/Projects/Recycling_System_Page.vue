    ...
    <v-container class="fill-height">
        <v-responsive class="fill-height text-center">
            ...
            <v-row class="py-5 px-0 d-flex align-center justify-center">
                <v-col>
                    <v-img cover height="300" src="@/assets/Projects_Images/Recycling_System/banner.jfif">
                    </v-img>
                </v-col>
            </v-row>
            ...
            <v-row class="py-5 px-5 d-flex justify-center bg-light-blue-lighten-5">
                <v-col>
                    <v-card title="Applicable Technical Skills">
                ...
                <v-col>
                    <v-card title="Applicable Soft Skills">
            ...
            <v-row class="py-5 px-5 d-flex align-center justify-center bg-light-blue-lighten-5">
                ...
                <!-- Summary -->
                <v-card title="Project Description" class="mx-auto">

                    <v-card-text class="text-subtitle-1">
                        Our team was given the task of designing a system to sort and recycle bottles into their
                    ...
                    <v-img cover width="800"
                        src="@/assets/Projects_Images/Recycling_System/starting_virtual_environment.png"
                        class="mx-auto">
                    </v-img>

                    <v-card-text class="font-weight-light">
                        Starting Virtual Environment in Quanser
                    </v-card-text>
            ...
            <v-row class="py-5 px-5 d-flex align-center justify-center bg-light-blue-lighten-5">
                <v-card title="Design Process" class="mx-auto">
                    ...
                    <v-card-text class="text-subtitle-1">
                        As part of the computing sub-team, I was responsible for designing a process to dispense the
                    ...
                    <v-img cover width="800" src="@/assets/Projects_Images/Recycling_System/bottle_properties.png"
                        class="mx-auto">
                    </v-img>

                    <v-card-text class="font-weight-light">
                        Table of all Bottle Properties
                    </v-card-text>

                    <v-card-text class="text-subtitle-1">
                        We had the option of choosing a maximum of two out of four possible sensors on the q-bot to
                    ...
                    <v-img cover width="800" src="@/assets/Projects_Images/Recycling_System/Q-bot_unloading.png"
                        class="mx-auto">
                    </v-img>

                    <v-card-text class="font-weight-light">
                        Q-bot Unloading the Bottles
                    </v-card-text>

                    <v-card-text class="text-subtitle-1">
                        The most challenging portion of this assignment was due to the inaccuracy of the sensors and the
                    ...
                    <v-img cover width="800" src="@/assets/Projects_Images/Recycling_System/loading_bottle.png"
                        class="mx-auto">
                    </v-img>

                    <v-card-text class="font-weight-light">
                        Loading a Bottle onto the Q-bot
                    </v-card-text>
            ...
            <v-row class="py-5 px-5 d-flex align-center justify-center bg-light-blue-lighten-5">
                <v-card title="Conclusion" class="mx-auto">
                    ...
                    <v-card-text class="text-subtitle-1">
                        This project was an eye-opener in terms of applying programming to a physical environment. It
                        ...
                        skills that will be valuable in the future. I have also attached the code I created below.
                    </v-card-text>

                    <v-btn class="mx-auto mb-5" color="primary" href="Thurs-12_P3_Python_Program.py" download outlined>
                        View Code
                    </v-btn>
                </v-card>
            </v-row>
