import{B as p,S as f,V as o,T as w,C as s,a as t}from"./CardText-e6420e16.js";import{V as g,P as y,c as r}from"./VCard-32c3a478.js";import{k}from"./index-7269ef44.js";import{I,C as v,D as _,E as a,m as e,O as i,F as l,M as d}from"./index-da3b0969.js";import"./ssrBoot-d15295bb.js";const b="Workplace Safety and Insurance Board (WSIB)",T=`During the summer of 2023, I had the opportunity to work at the Workplace Safety and Insurance Board (WSIB) 
    ...
    `,x="What I learned",C=`The operations vendor management team at WSIB was responsible for managing 20+ contracts with different
    ...
    are set depending on the stakeholders involved.`,S=`I was also able to glimpse into the world of data analysis and was tasked with creating tools that would
    ...
    on contracts, case numbers, and other relevant information.`,B="Conclusion",V=`This internship was an amazing experience and I am thankful to have had the opportunity to work with such
    ...
    and I look forward to applying what I have learned in my future career.`,A={__name:"WSIB",setup(W){const c=new URL("/assets/banner-176222b3.png",self.location).href,h=["Microsoft Office","Data Analysis","Data Visualization"],m=["Teamwork","Communication","Time Management","Problem Solving","Research"],u=new URL("/assets/summary-c358e9e9.jpg",self.location).href;return(P,D)=>{const n=I("v-slot");return v(),_(g,{class:"fill-height"},{default:a(()=>[e(k,{class:"fill-height text-center"},{default:a(()=>[e(p,{imagePath:i(c)},null,8,["imagePath"]),e(y,{titleText:b}),e(f,{technical_skills_items:h,soft_skills_items:m}),e(o),e(w,{summaryText:T,summaryImg:i(u)},null,8,["summaryImg"]),e(o),e(s,null,{default:a(()=>[e(n,null,{default:a(()=>[e(r,null,{default:a(()=>[l(d(x))]),_:1}),e(t,{text:C}),e(t,{text:S})]),_:1})]),_:1}),e(s,null,{default:a(()=>[e(n,null,{default:a(()=>[e(r,null,{default:a(()=>[l(d(B))]),_:1}),e(t,{text:V})]),_:1})]),_:1})]),_:1})]),_:1})}}};export{A as default};
