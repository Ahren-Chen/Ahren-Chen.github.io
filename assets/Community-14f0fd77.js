import{B as w,S as b,V as s,T as y,C as n,a}from"./CardText-43be0701.js";import{V as v,P as T,c as r}from"./VCard-b22d6519.js";import{T as x}from"./TwoColumnImage-cb6bc58a.js";import{F as _}from"./FigureText-c178f39d.js";import{V as P,k as j}from"./index-cc1bb379.js";import{I as C,C as I,D as k,E as t,m as e,O as o,F as l,M as c,G as V}from"./index-5c784a8e.js";import"./ssrBoot-86103078.js";const M=V("iframe",{width:"882",height:"535",src:"https://www.youtube.com/embed/tX62yW6jxWg"},null,-1),O="Power In The Community",S=`Our client James allowed us to create a design that would improve an aspect of his daily
  ...
  having to reach for them.`,W="Design Process",J=`We first decided on the primary aspect of James's life that we were going to improve and settled
  ...
  our ideas.`,D="Inventor Model",R="Multiview Sketch of Dice Roller",L=`The aspect I focused on was how to let James roll dice while using minimal movement. My solution
  ...
  physical prototypes after selecting the best design for each component.`,U="Low-Fidelity Prototype",B=`After multiple iterations, we modified our final design to include a card slider to move cards
  ...
  reduce the force needed to transfer the cards.`,F="Conclusion",A=`This was my first project that involved a real client and the freedom to decide what we built
  ...
  creativity/problem solving to the fullest.`,Z={__name:"Community",setup(G){const d=new URL("/assets/community_banner-11bc769c.jfif",self.location).href,m=["Autodesk Inventor","Microsoft Office","Prusa Slicer","Prototyping"],h=["Teamwork","Communication","Time Management","Problem Solving","Creativity"],u=new URL("/assets/gamehub-38f1a17c.png",self.location).href,f=new URL("/assets/community_inventor-88fa347b.png",self.location).href,p=new URL("/assets/community_multiview-500da779.png",self.location).href,g=new URL("/assets/prototype-4a2a3dda.png",self.location).href;return(N,E)=>{const i=C("v-slot");return I(),k(v,{class:"fill-height"},{default:t(()=>[e(j,{class:"fill-height text-center"},{default:t(()=>[e(w,{imagePath:o(d)},null,8,["imagePath"]),e(T,{titleText:O}),e(b,{technical_skills_items:m,soft_skills_items:h}),e(s),e(y,{summaryText:S,summaryImg:o(u)},null,8,["summaryImg"]),e(s),e(n,null,{default:t(()=>[e(i,null,{default:t(()=>[e(r,null,{default:t(()=>[l(c(W))]),_:1}),e(a,{text:J}),e(x,{imageOne:o(f),imageTwo:o(p),textOne:D,textTwo:R},null,8,["imageOne","imageTwo"]),e(a,{text:L}),e(P,{cover:"",width:"500",src:o(g),class:"mx-auto"},null,8,["src"]),e(_,{text:U}),e(a,{text:B})]),_:1})]),_:1}),e(n,null,{default:t(()=>[e(i,null,{default:t(()=>[e(r,null,{default:t(()=>[l(c(F))]),_:1}),e(a,{text:A}),M]),_:1})]),_:1})]),_:1})]),_:1})}}};export{Z as default};
